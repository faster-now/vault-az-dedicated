...
resource "null_resource" "bootstrap_ansible" {
    ...
    provisioner "remote-exec" {
        inline = [
            ...
            "sudo chown -R azureuser:azureuser ~/.local",
            "pipx install ansible-core",
            "pipx ensurepath",
            "~/.local/share/pipx/venvs/ansible-core/bin/ansible-galaxy collection install community.hashi_vault",
            "~/.local/share/pipx/venvs/ansible-core/bin/ansible-galaxy collection install community.general",
            "pip install -t ~/.local/share/pipx/shared/lib/python3.12/site-packages hvac",
